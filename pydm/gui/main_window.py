...
class MainWindow(QMainWindow):
    ...
    def init_ui(self):
        """初始化UI"""
        self.setWindowTitle("大漠免COM注册系统 v2.0 - 虚拟机器码版")
        ...
        self.tabs.addTab(config_tab, "⚙️ 配置")
        
        # 虚拟机器码管理标签页
        self.virtual_code_tab = VirtualCodeTab(self.profile_mgr)
        self.tabs.addTab(self.virtual_code_tab, "🔑 虚拟机器码")
    ...
    def create_config_tab(self):
        ...
        reg_layout.addWidget(QLabel("<b>注册设置</b>"))
        
        reg_code_layout = QHBoxLayout()
        reg_code_layout.addWidget(QLabel("注册码:"))
        ...
        add_code_layout.addWidget(QLabel("附加码:"))
        ...
        machine_layout.addWidget(QLabel("<b>虚拟机器设置</b>"))
        
        count_layout = QHBoxLayout()
        count_layout.addWidget(QLabel("机器数量:"))
        ...
        self.start_btn = QPushButton("▶️ 启动注册")
    ...
    def load_config(self):
        ...
        self.max_count_spin.setValue(self.config.get_max_register_count())
    ...
    def save_config(self):
        ...
        self.config.set_max_register_count(self.max_count_spin.value())
    ...
    def start_register(self):
        ...
        if current_count < target_count:
            ...
            for i in range(target_count - current_count):
                ...
                profile['machine_code'] = '未注册'  # 添加机器码字段
        ...
        self.status_monitor.set_status("运行中", "green")
        self.statusBar.showMessage("注册循环已启动")
    ...
    def stop_register(self):
        ...
        self.stop_btn.setEnabled(False)
        self.status_monitor.set_status("已停止", "orange")
        self.statusBar.showMessage("注册循环已停止")
